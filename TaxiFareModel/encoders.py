...
class TimeFeaturesEncoder(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        return X_copy.reset_index(drop=True)[['dow', 'hour', 'month', 'year']]
...
class DistanceTransformer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        return pd.DataFrame(haversine_vectorized(X,self.start_lat, self.start_lon, self.end_lat, self.end_lon)).rename(columns={0: 'distance'}).reset_index()[['distance']]
